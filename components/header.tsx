      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Lazur Resort</h1>
              <p className="text-sm text-gray-600">Rogowo - domki nad morzem</p>
            </div>
          </Link>
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <Link href="/okolica" className="text-gray-700 hover:text-blue-600 transition-colors">
              Okolica
            </Link>
            ...
            <Link href="/rezerwacja">
              <Button className="bg-blue-600 hover:bg-blue-700">Rezerwuj</Button>
            </Link>
          </nav>
        ...
        {isMenuOpen && (
          <nav className="lg:hidden mt-4 pb-4 border-t pt-4">
            <div className="flex flex-col space-y-4">
              ...
              <Link href="/rezerwacja">
                <Button className="bg-blue-600 hover:bg-blue-700 w-full">Rezerwuj</Button>
              </Link>
            </div>
          </nav>
        )}
